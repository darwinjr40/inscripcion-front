...
export const ButtonConfirmInter = ({onState}) => {
    ...
    return (
        <div>
            <button  onClick={handleShowConfirmation}
                ...
                // "
                className="mt-3 w-full justify-center rounded-md bg-blue-600 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse   text-base font-medium text-white hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500               
                "
            >
                GRABAR MATERIAS
            </button>
