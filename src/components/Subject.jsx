  ...
  return (
    <>    
      ...
      <table className="table-auto my-6 border w-full shadow">
        <thead>
            <tr className="border-b">
                ...
                <th className="py-2 px-3">Grupos</th>
        ...
        <tbody>
            <tr className="text-center ">
                ...
                <td className=" py-2 px-3">INF110</td>
                <td className=" py-2 px-3">Intorduccion a la informatica</td>
      ...
      <div className="flex mb-4 text-center" >
        <div className="w-1/5 bg-gray-500 h-12">1</div>
        <div className="w-1/5 bg-gray-400 h-12">INF110</div>
        <div className="w-1/5 bg-gray-500 h-12">Intorduccion a la informatica</div>
        <div className="w-1/5 bg-gray-400 h-12">3</div>
        <div className="w-1/5 bg-gray-500 h-12">30</div>
      </div>
  ...
  {/* <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    ...
    {/* <button type="button" class="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 mr-2 mb-2">
      ...
      <fieldset className="border border-black p-4">
        ...
        <legend className="text-lg font-bold">Información personal:</legend>
        
        <button className="w-full">
            <div className="flex mb-4 text-center" >
              <div className="w-1/5 bg-gray-500 h-12 py-3">1</div>
              <div className="w-1/5 bg-gray-400 h-12 py-3">INF110</div>
              <div className="w-1/5 bg-gray-500 h-12 py-3">Introduccion a la informatica</div>
              <div className="w-1/5 bg-gray-400 h-12 py-3">3</div>
              <div className="w-1/5 bg-gray-500 h-12 py-3">30</div>
            </div>
        </button>
        
        <div className="flex mb-4 text-center" >
          <div className="w-1/5 bg-gray-400 h-12 py-3">
            <input type="radio" id="kraken" name="monster" value="K"/>
          </div>
          <div className="w-1/5 bg-gray-500 h-12  py-3" >SA</div>
          <div className="w-1/5 bg-gray-400 h-12  py-3" >Peinado Pereira Miguel Jesus</div>
          <div className="w-1/5 bg-gray-500 h-12  py-3" >20 cupos Disponibles</div>
          <div className="w-1/5 bg-gray-400 h-12  py-3" >Lun 07:00 - 08:30</div>
        </div>
      ...
      <fieldset className="border p-4">
        ...
        <div className="mb-4">
          <input type="radio" id="kraken" name="monster" value="K"/> &nbsp;&nbsp;&nbsp;&nbsp;
          <label htmlFor="kraken">SA</label> &nbsp;&nbsp;&nbsp;&nbsp;
          <label htmlFor="kraken">Peinado Pereira Miguel Jesus</label> &nbsp;&nbsp;&nbsp;&nbsp;
          <label htmlFor="kraken">20 cupos Disponibles</label> &nbsp;&nbsp;&nbsp;&nbsp;
          <label htmlFor="kraken">Lun 07:00 - 08:30</label>
        </div>
